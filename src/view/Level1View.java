...
public class Level1View extends LevelView{
	...
	public Level1View(boolean multiplayer) { 
		...
		layerAux = new Camada("imgs/oneBlockTile.png", 15, 15, 64, 64, "/util/level1/layerAux.txt"); 
		...
		enemies.add(new Enemy(new Sprite(new File("imgs/enemy1.png"), 0, 3, 4, 448, 182), 3)); 
		enemies.add(new Enemy(new Sprite(new File("imgs/enemy1.png"), 0, 3, 4, 192, 502), 3));
